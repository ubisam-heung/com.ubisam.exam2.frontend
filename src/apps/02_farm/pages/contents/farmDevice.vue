  ...
  <v-container class="pa-4" fluid>
    <v-card>
      <v-card-title class="d-flex align-center pe-2">
        ...
        {{ $t("frontend.contents.farmDevices.title") }}&nbsp;
        <!-- 
        //////////////////////////
        // Search Field Start
        //////////////////////////
      ...
      >
        ...
        <template v-slot:item.farmDeviceType="{ item }">
          {{ item.farmDeviceType ? item.farmDeviceType.farmDeviceTypeName : "-" }}
        </template>
        <!-- 
        //////////////////////////
      ...
      <v-dialog v-model="dialog" persistent width="800">
        <v-card
          ...
          :title="$t('frontend.contents.farmDevices.title')"
          :subtitle="editForm.farmDeviceSerial"
        >
          <v-card-text>
            <v-form validate-on="eager" @update:model-value="dialogValidate">
              ...
              -->
              <v-text-field
                v-model="editForm.farmDeviceSerial"
              ...
              ></v-text-field>
              <v-text-field
                v-model="editForm.farmDeviceState"
                :rules="[$rules.requried]"
                label="State"
                placeholder="state"
                hint="......."
              ...
              <entity-field
                class="ma-2"
                v-model="editForm.farmDeviceTypeLink"
                :rules="[$rules.requried]"
                :items="farmDeviceTypeItems"
                :item-selected="editForm.farmDeviceType"
                :item-title="farmDeviceTypeItemsTitle"
                :item-value="farmDeviceTypeItemsValue"
                :loading="farmDeviceTypeItemsLoading"
                @querySelections="farmDeviceTypeItemsQuery"
                density="default"
                varient="outlined"
                placeholder="FarmDeviceType"
                hint="......."
                chips
              >
              </entity-field>
              <entity-collections
                ...
                class="ma-2"
                :disabled="true"
                v-model="editForm.farmDeviceHistory"
                :item-headers="farmDeviceHistoryItemsHeader"
                :item-editable="false"
              >
              </entity-collections>
              <!-- 
...
export default {
  data: () => ({
    ...
    config: {
      ...
      searchOptions: [
        { value: 'farmDeviceAll', text: '전체' },
        { value: 'farmDeviceSerial', text: '시리얼번호' },
        { value: 'farmDeviceState', text: '상태' },
      ],
      ...
      headers: [
        ...
        { key: "farmDeviceSerial", title: "Serial", align: "start" },
        { key: "farmDeviceState", title: "State", align: "center" },
        { key: "farmDeviceType", title: "Farm Device", align: "end" },
      ],
      sortBy: [
        {key: "id", order: "desc" }
      ],
      ...
      initForm: {
        id: undefined,
        farmDeviceSerial: undefined,
        farmDeviceState: undefined,
        farmDeviceType: undefined,
        farmDeviceTypeName: undefined,
      }
      /////////////////////////////////
      // Config End
      /////////////////////////////////
    ...
    farmDeviceTypeItems : [],
    farmDeviceTypeItemsValue: "id",
    farmDeviceTypeItemsTitle: "farmDeviceTypeName",
    farmDeviceTypeItemsLoading: false,

    farmDeviceHistoryItemsHeader : [
      { key: "farmDeviceName", title: "Name", align: "start", width: "30%"},
      { key: "farmDeviceState", title: "State", align: "center", width: "30%"},
      { key: "farmDeviceTimestamp", title: "Timestamp", align: "end", width: "30%"},
    ],
  }),
  ...
  methods: {
    ...
    // query....
    ////////////////////////////////////////
    farmDeviceTypeItemsQuery(v){
      console.log(x, "farmDeviceTypeItemsQuery", 1, v);
      this.farmDeviceTypeItemsLoading = true;
    ...
    ////////////////////////////////////////
    handleCreate(){
      return $farmServer.farmDevices.create(this.editForm);
    },
    handleRead(entity){
      return $farmServer.farmDevices.read(entity);
    },
    handleUpdate(){
      return $farmServer.farmDevices.update(this.editForm);
    },
    handleDelete(){
      return $farmServer.farmDevices.delete(this.editForm);
    },
    handleSearch(query){
      return $farmServer.farmDevices.search(this.searchForm, query);
    },
    handleEntities(res){
      this.entitiesTotal = res.page.totalElements;
      this.entities = res._embedded.farmDevices;
      return res;
    },
    handleEntity(res){

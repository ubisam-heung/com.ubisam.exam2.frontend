  ...
  <v-container class="pa-4" fluid>
    <v-card>
      <v-card-title class="d-flex align-center pe-2">
        ...
        {{ $t("frontend.contents.farmDeviceTypes.title") }}&nbsp;
        <!-- 
        //////////////////////////
        // Search Field Start
        //////////////////////////
      ...
      <v-dialog v-model="dialog" persistent width="800">
        <v-card
          ...
          :title="$t('frontend.contents.farmDeviceTypes.title')"
          :subtitle="editForm.farmDeviceTypeName"
        >
          <v-card-text>
            <v-form validate-on="eager" @update:model-value="dialogValidate">
              ...
              -->
              <v-text-field
                v-model="editForm.farmDeviceTypeKey"
              ...
              ></v-text-field>
              <v-text-field
                v-model="editForm.farmDeviceTypeName"
                :rules="[$rules.requried]"
                label="Name"
                placeholder="name"
                hint="......."
              ...
              ></v-text-field>
              <v-text-field
                v-model="editForm.farmDeviceTypeUnit"
                :rules="[$rules.requried]"
                label="Unit"
                placeholder="unit"
                hint="......."
...
export default {
  data: () => ({
    ...
    searchForm: {
      keyword: '', option: 'farmDeviceTypeAll'
    },
    editForm: {},
    ...
    config: {
      ...
      searchOptions: [
        { value: 'farmDeviceTypeAll', text: '전체' },
        { value: 'farmDeviceTypeKey', text: '키값' },
        { value: 'farmDeviceTypeName', text: '이름' },
      ],
      ...
      headers: [
        ...
        { key: "farmDeviceTypeKey", title: "Key", align: "start" },
        { key: "farmDeviceTypeName", title: "Name", align: "center" },
        { key: "farmDeviceTypeUnit", title: "Unit", align: "end" },
      ],
      sortBy: [
        {key: "id", order: "desc" }
      ],
      ...
      initForm: {
        farmDeviceTypeKey: undefined,
        farmDeviceTypeName: undefined,
        farmDeviceTypeUnit: undefined,
      }
      /////////////////////////////////
      // Config End
      /////////////////////////////////
  ...
  methods: {
    ...
    ////////////////////////////////////////
    handleCreate(){
      return $farmServer.farmDeviceTypes.create(this.editForm);
    },
    handleRead(entity){
      return $farmServer.farmDeviceTypes.read(entity);
    },
    handleUpdate(){
      return $farmServer.farmDeviceTypes.update(this.editForm);
    },
    handleDelete(){
      return $farmServer.farmDeviceTypes.delete(this.editForm);
    },
    handleSearch(query){
      return $farmServer.farmDeviceTypes.search(this.searchForm, query);
    },
    handleEntities(res){
      this.entitiesTotal = res.page.totalElements;
      this.entities = res._embedded.farmDeviceTypes;
      return res;
    },
    handleEntity(res){
